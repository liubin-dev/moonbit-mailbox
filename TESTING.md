...
- Local code coverage: `moon coverage analyze -p localreview/mailbox -- -f summary`. No coverage upload is configured. Coverage is evidence about current code, not upstream feature coverage.
